...
VASP_ANYOP("vasp.int",int,true) 
VASP_ANYOP("vasp.dif",dif,true) 
/*
VASP_ANYOP("vasp.peaks",peaks,true) 
VASP_ANYOP("vasp.rpeaks",rpeaks,true) 
VASP_ANYOP("vasp.valleys",valleys,true) 
VASP_ANYOP("vasp.rvalleys",rvalleys,true) 
*/
VASP_ANYOP("vasp.gate",gate,true) 
VASP_ANYOP("vasp.rgate",rgate,true) 
VASP_ANYOP("vasp.opt*",optf,true) 
VASP_ANYOP("vasp.ropt*",roptf,true) 
...
VASP_ANYOP("vasp.cpowi",cpowi,true) 
VASP_ANYOP("vasp.rpow",rpow,true) 
VASP_ANYOP("vasp.r+",radd,true) 
...
VASP_ANYOP("vasp.xshift",xshift,true)
VASP_ANYOP("vasp.rot",rot,true)
VASP_ANYOP("vasp.xrot",xrot,true)
...
VASP_ANYOP("vasp.window",window,false)
VASP_ANYOP("vasp.*window",mwindow,true)
